...
Move route orchestration out of the monolithic server into auth, workspace, discovery, evidence and tailoring modules as migration scope requires; those modules do not exist yet.
