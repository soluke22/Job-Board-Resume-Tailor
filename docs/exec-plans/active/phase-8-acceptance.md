...
| Reproducibility | Node 24 npm ci/typecheck/tests/build with no .env | Vercel explicit install/build settings [3][5] | Pass locally | Sandbox cache/network install failed; authorized rerun succeeded; six moderate npm advisories deferred to Phase 9 |
