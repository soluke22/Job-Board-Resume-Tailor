    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-300 mt-1 max-w-3xl">
              Searches directly across verified Ashby, Greenhouse, Lever, and company career boards aligned strictly with verified candidate evidence in React, TypeScript, and component systems.
            </p>
          </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between text-xs text-slate-400 px-1">
          <span>Showing {filteredJobs.length} verified candidate matches</span>
          <span>Sorted by Evidence Fit &amp; Freshness</span>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                  ...
                  <div className="p-3 rounded-xl bg-slate-950/40 border border-slate-800/80 space-y-1">
                    ...
                    <ul className="space-y-1 text-slate-300">
                      {(job.hiringSignals || [job.priorityReason || 'High match with candidate verified evidence']).slice(0, 2).map((sig, i) => (
                  ...
                  <div className="p-3 rounded-xl bg-slate-950/40 border border-slate-800/80 space-y-1">
                    ...
                    {hasBlockers ? (
                      ...
                      <div className="text-slate-300 flex items-start space-x-1.5">
                        ...
                        <span>Zero deterministic blockers. Candidate clears clearance, location, and stack criteria.</span>
                      </div>
                    )}
                  </div>
                </div>
